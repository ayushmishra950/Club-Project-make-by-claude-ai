...
export const addReviews = async (obj: any) => {
    const res = await api.post(`/admin/reviews/add`, obj);
    return res;
};

export const getReviews = async () => {
    const res = await api.get(`/admin/reviews/get`);
    return res;
};
...
export const updateReviewStatus = async (obj) => {
    const res = await api.patch(`/admin/reviews/status/update`, obj);
    return res;
}
